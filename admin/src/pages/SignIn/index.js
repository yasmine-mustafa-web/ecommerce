    ...
    <input type="username"     value={formfields.username} onChange={onchangeInput} required name="username" className="form-control" id="username" placeholder="name@example.com"/>
