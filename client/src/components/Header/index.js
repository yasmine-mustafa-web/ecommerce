                ...
                <header className="header py-2">
                    <div className="container-fluid">
                        <div className="d-flex align-items-center justify-content-between">
                         ...
                         <div className='part3 d-md-flex d-none align-items-center gap-2' >                          
                        ...
                        <>
                            <button style={{flexWrap:"nowrap" , whiteSpace:"nowrap"}} className="signIn btn bg-red text-white me-2 rounded-4 text-nowrap" onClick={() => navigate('/signIn')}>Sign In</button>
                            <button style={{flexWrap:"nowrap" , whiteSpace:"nowrap"}} className="signUp btn me-2 rounded-4 text-nowrap" onClick={() => navigate('/signUp')}>Sign Up</button>
                            <button style={{flexWrap:"nowrap" , whiteSpace:"nowrap"}} className="signUp btn me-2 rounded-4 text-nowrap" onClick={() => window.open('https://admin-dashboard-flax-nu-76.vercel.app/' , '_blank')}>Admin Dashboard</button>
